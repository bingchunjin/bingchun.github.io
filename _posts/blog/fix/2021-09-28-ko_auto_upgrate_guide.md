...
### 1.2 开发环境
openwrt系统编译环境，环境搭建请参考[快速入门手册](https://bingchun.github.io/2020/08/05/quick_start/)
...
### 2.2 引入一个新的板型或使用公用板型
板型引入请参考[新的版型引入指南](https://bingchun.github.io/2020/09/08/newBoardImportGuide/) ，以下以a28_ac28s板型为例。
...
## 3 项目引用
### 3.1 参考文档
- [快速入门手册](https://bingchun.github.io/2020/08/05/quick_start/)
- [新的版型引入指南](https://bingchun.github.io/2020/09/08/newBoardImportGuide/)
